    ...
    while not stopping_condition_met:
        ...
        for minibatch_id, training_minibatch in enumerate(train_loader, 0):
            ...
            if minibatches_proccesed % args.eval_interval == 0:
                ...
                (phi_list, psi_list, omega_list) = calculate_dihedral_angels(pos, use_gpu)
                (phi_list_pred, psi_list_pred, omega_list_pred) = calculate_dihedral_angels(pos_pred, use_gpu)
